...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Definitions}{name=Definitions,column=1, span=2,below=Alice Has A Secret }{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\noindent \textbf{Bell State Measurement}: hcjkhugyftygoiuggch \\
\textbf{Bell State Measurement}: hcjkhugyftygoiuggch \\
\textbf{Bell State Measurement}: hcjkhugyftygoiuggch \\
\textbf{Bell State Measurement}: hcjkhugyftygoiuggch \\
...
\noindent However Bob has had one too many Barnsley Bitters and can no longer remember what he sent to Alice. Just like Eve, Bob is now locked out of the network, as Charlie can no longer verify him as a network user. Silly forgetful Bob!  

\begin{center}
    \includegraphics[width=0.3\linewidth]{img/drunk_spy} 
\end{center} 
